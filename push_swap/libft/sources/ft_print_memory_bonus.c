...
/*   Updated: 2021/05/01 20:53:28 by seyu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void
	write_addr(int scale, unsigned long long addr)
{
	if (scale == 0)
		return ;
...
static void
	write_hex(void *addr, unsigned int size)
{
	int				blank;
	unsigned int	idx;
...
static void
	write_char(char *addr, unsigned int size)
{
	unsigned int	idx;
