...
/*   Updated: 2021/05/01 21:01:04 by seyu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int
	isincluded(char ch, char const *str)
{
	size_t	idx;
...
static size_t
	get_start_idx(char const *str, char const *set)
{
	size_t	start_idx;
...
static size_t
	get_end_idx(char const *str, char const *set)
{
	size_t	end_idx;
	...
	*ft_strtrim(char const *s1, char const *set)
{
	...
	if (start_idx > end_idx)
		str_trimmed = malloc(sizeof(char));
	else
		str_trimmed = malloc(sizeof(char) * end_idx - start_idx + 1);
	if (str_trimmed == NULL)
		return (0);
	idx = 0;
